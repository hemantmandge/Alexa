...
public class ShellExecuter{
 ...
 private static String USERNAME ="admin"; // username for remote host
 private static String PASSWORD ="cat@asd"; // password of the remote host
 private static String host = "10.67.5.245"; // remote host address
